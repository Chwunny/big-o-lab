...
// ANSWER: O(1), No because youre directly grabbing two indexes, it would be slower to check the indexes and then push
...
function squareEveryDigit(number) {
    let map1 = number.toString().split('').map(x => x * x)
    return map1.join('')
}
